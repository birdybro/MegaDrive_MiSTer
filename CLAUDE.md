...
The `rtl/nuked-md/` files have been partially annotated with descriptive signal names and section comments. When working in these files:
...
- **`ym7101.v`** — Still uses original opaque signal names (e.g., `w12`, `l136`). This file is very large and has NOT been annotated yet.
